...
\noindent The testbench I used to simulate the WRPC is located in \href{https://gitlab.com/ohwr/project/wr-cores/-/tree/master/testbench/wrc_core}{testbench/wrc\_core} and is split into three different parts, as shown in the following image:
...
\caption{Scheme of the test bench.}
\label{fig:tb-scheme}
\end{figure}

\noindent [Add explication of the tb flow]
